...
sw=:verb define
	NB.  Want to save all open files
	NB.  Shall I save output window?  I don't think so - that would seriously bloat my *.jws files
	NB.  Want to save state and location of main window in [Main]
	NB.  Want to save the state and location of output in [Main] or maybe [Output]
	NB.  Want to save state and location of all other files in [Scripts]
	NB.  Don't think I can follow original plan here (i.e. table driven) - need special handling of certain commands.
	NB.  Want to save name of focussed window, or 'out' if out.
)
NB.=======================================================
...
loadWorkspace			=: verb define
	...
	setWindowParams 'Windows' map~ iniData
