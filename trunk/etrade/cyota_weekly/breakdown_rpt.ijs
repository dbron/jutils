...
RANGE=:DATEs #~ MASK =: (+. 1&|.) 1 = DATEs I.~ ,:2007 03 05  NB. 2007 01 12 NB. (,:2006 12 28) NB. 2007 01 sp 1 7
...
RET=:1 0 0 0 0 1 0 (] <;.1~ [: , ,:@:[ $~ %&#~) RANGE {.~ 1+Sun i:~ s: 'WWW' dateToString"1 RANGE

SOUR =: rower@:power each RET
